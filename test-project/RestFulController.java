...
public class RestFulController {
	...
	@RequestMapping(value="/tasks/{param1}",method = RequestMethod.GET,headers="Accept=application/json")
	  public String getResponse(@PathVariable String param1) {  
		System.out.println("Rest Service is called:"+param1);
		return "success1";
	  }
	/*
	@RequestMapping(value="/tasks",method = RequestMethod.GET,headers="Accept=application/json")
